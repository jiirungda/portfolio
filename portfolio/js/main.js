$(document).ready(function(){
	...
	const myFullpage = new fullpage('#fullpage', {  /* html에서 페이지 전체를 감싸는 요소 */
		...
		lockAnchors: false,
		anchors: ['main', 'profile', 'project01', 'project02', 'project03', 'thankyou'], /* href="#link1" 이렇게 코딩하면 해당 링크명으로 이동 */
	...
	const project03_swiper = new Swiper('.project03 .swiper', { /* 팝업을 감싼는 요소의 class명 */
        ...
        navigation: {  /* 이전, 다음 버튼 */
            nextEl: '.project03 .btn_wrap button.btn_next',  /* 다음 버튼의 클래스명 */
            prevEl: '.project03 .btn_wrap button.btn_prev',  
        },
